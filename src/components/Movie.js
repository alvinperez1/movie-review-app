...
const Movie = ({ movie, addReview }) => {
    ...
    return (
            ...
            <div className="movies-container">
                <div>
                <div className="card m-5 w-50 mx-auto bg-danger bg-opacity-10 d-block border border-danger">
                    <img className='m-4 rounded mx-auto' src={movie.img} alt="movie poster" />
                <div className="card-body rounded mb-2 w-50 mx-auto bg-light border border-danger">
